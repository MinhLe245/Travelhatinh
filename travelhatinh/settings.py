"""
Django settings for travelhatinh project.
...
DEBUG = False # Cân nhắc đặt False khi triển khai lên production để bảo mật hơn
...
ROOT_URLCONF = 'travelhatinh.urls'
...
WSGI_APPLICATION = 'travelhatinh.wsgi.application'
